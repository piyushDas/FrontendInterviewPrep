...
function Car( model, year, miles ) {
  ...
  // it makes inheritance difficult and the other is that 
  // functions such as toString() are redefined
  // for each of the new objects created using the Car constructor.
